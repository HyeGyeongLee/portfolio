...
const _routes = [
  {
    name: "Archiving",
    path: "/Archiving",
    component: () => import('./Archiving-DsVHK_JW.mjs').then((m) => m.default || m)
  },
  {
    name: "Career",
    path: "/Career",
    component: () => import('./Career-B76xrN3N.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-D44TPsKp.mjs').then((m) => m.default || m)
  },
  {
    name: "Project",
    path: "/Project",
    component: () => import('./Project-DJJNn-bo.mjs').then((m) => m.default || m)
  },
  {
    name: "Skills",
    path: "/Skills",
    component: () => import('./Skills-CO-nPnTf.mjs').then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import('./default-DdUYV5fN.mjs').then((m) => m.default || m)
};
