...
const _routes = [
  {
    name: "Archiving",
    path: "/Archiving",
    component: () => import("./_nuxt/Archiving-DsVHK_JW.js").then((m) => m.default || m)
  },
  {
    name: "Career",
    path: "/Career",
    component: () => import("./_nuxt/Career-B76xrN3N.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-D44TPsKp.js").then((m) => m.default || m)
  },
  {
    name: "Project",
    path: "/Project",
    component: () => import("./_nuxt/Project-DJJNn-bo.js").then((m) => m.default || m)
  },
  {
    name: "Skills",
    path: "/Skills",
    component: () => import("./_nuxt/Skills-CO-nPnTf.js").then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import("./_nuxt/default-DdUYV5fN.js").then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-C_Vd0vrh.js").then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-BicTHyR_.js").then((r) => r.default || r));
